...
p_desc = "c://Users/aborr/research/ILS/HERG/results/NCAST_CHEMBL/analysis_NCAST_CHEMBL/Cleaned_Data/desc_cleaned.csv"
p_AC50 = "c://Users/aborr/research/ILS/HERG/results/NCAST_CHEMBL/analysis_NCAST_CHEMBL/Cleaned_Data/AC50_cleaned.csv"
prout = "c://Users/aborr/research/ILS/HERG/results/NCAST_CHEMBL/analysis_NCAST_CHEMBL/PCA_NCATS_CHEMBL/"
...
ddesc = read.csv(p_desc, sep = ",", row.names = 1)
ddesc2 = ddesc[grep("^CHEMBL*", rownames(ddesc)), ]
ddesc1 = ddesc[-grep("^CHEMBL*", rownames(ddesc)),]

# remove SMILES
#ddesc2 = ddesc2[,-1]

daff = read.csv(p_AC50, header = TRUE, row.names = 1)
daff2 = daff[grep("^CHEMBL*", rownames(daff)), ]
daff1 = daff[-grep("^CHEMBL*", rownames(daff)), ]
...
points(add_coord[,1], add_coord[,2], col = vcolor_add, pch = 8, cex = 2.5)
abline(h=0,v=0)
warnings ()
dev.off()
